...
The [analysis guide](analysis/README.md) documents Python and R setup and the commands for regenerating inputs, results, and figures. The source classifications, wind databases, and reviewed temperature records are included. The original cell-level JSON annotations are also published alongside the software in the [classifier repository](https://github.com/kylenessen/monarch_trailcam_classifier/tree/main/data/classifications). Original photographs are excluded for storage reasons. The observational data are documented in the [USGS data release](https://doi.org/10.5066/P13IEKEB) by Nessen, Ibsen, Diffendorfer and Villablanca (2026). See the [data availability notes](data/README.md) and [draft release tables](data/release/README.md) for scope and known gaps.
