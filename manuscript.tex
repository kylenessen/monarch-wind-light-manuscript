...
%% Abstract
%% ------------------------------------------------------------------
\abstract{The Wind Disruption Hypothesis predicts that strong winds reduce the abundance of overwintering western monarch butterfly (\textit{Danaus plexippus}) clusters. We paired time-lapse images with nearby wind measurements at two California groves during the 2023--2024 overwintering season. Image classifications yielded a Butterfly Index (BI) of visible cluster size and a sun-exposed BI. Across 1,894 paired 30-minute observations and 96 Next Day Windows, maximum wind gust was not consistently associated with declining BI. The 30-minute wind association depended jointly on approximate local temperature and sun-exposed BI. With positive sun-exposed BI, stronger gusts were associated with declining BI at \texorpdfstring{10$^{\circ}$C}{10 degrees Celsius} and increasing BI at \texorpdfstring{20$^{\circ}$C}{20 degrees Celsius}. No clear wind association was detected when sun-exposed BI was zero. The Next Day Window analysis also indicated that the wind association varied with sun-exposed BI, with greater model-selection uncertainty. Nearby maximum gusts did not measure sustained exposure at butterfly positions, so the study was not an exact test of the historical 2~m/s threshold. The results did not support a simple formulation of the Wind Disruption Hypothesis under the monitored conditions. Physiological responses to interacting wind, ambient temperature, and solar exposure offer a plausible hypothesis for future research.}
