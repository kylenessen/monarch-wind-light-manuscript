...
% USGS approval comment, original line 513. Peter will supply the final data release
% citation and DOI. Planned release publication date is 30 September 2026.
\dataavailability{Processed analysis datasets, model formulas, analysis code, and generated model outputs are publicly available at \url{https://github.com/kylenessen/monarch-wind-light-manuscript}. The illustrated classification protocol is available at \url{https://kylenessen.github.io/monarch_trailcam_classifier/}, and the source code for the custom image-classification software is available at \url{https://github.com/kylenessen/monarch_trailcam_classifier}. A USGS ScienceBase release containing the original photographs, deployment metadata, image classifications, wind measurements, and reviewed image-derived temperature values used in this study is scheduled for publication on 30 September 2026.}
