...
Each autumn, western monarch butterflies migrate from breeding areas across western North America to tree groves along the California coast, where they form dense overwintering aggregations \cite{reppertDemystifyingMonarchButterfly2018,Urquhart1978Autumnal,browerUnderstandingMisunderstandingMigration1995}. Within these groves, monarchs repeatedly cluster within a limited set of areas and trees, yet aggregations can shift during the season as conditions change \cite{leongUseMultivariateAnalyses1991,ibsenDensityDependenceHabitat2026}. Because abiotic conditions strongly shape invertebrate activity and habitat use, local microclimate offers a plausible explanation for this combination of predictable habitat use and short-term movement \cite{sextonEvolutionEcologySpecies2009,louthanWhereWhenSpecies2015}. Researchers have therefore long sought to identify the environmental conditions that distinguish monarch aggregation locations within overwintering groves.
...
These interpretations were subsequently incorporated into overwintering habitat assessments and management guidance. Wind speeds at or above 2~m/s were treated as disruptive, and wind protection became an important objective of grove management \cite{leongEvaluationManagementCalifornia2016,jepsenProtectingCaliforniasButterfly2017,xercessocietyManagingMonarchsWest2018}. Decisions about planting, pruning, and removing trees were therefore often made in response to perceived wind exposure and the need to maintain or restore sheltered conditions \cite{weissRecommendationsRestorationMonarch2008,peltonMonarchButterflyOverwintering2020,althouse&meadeinc.EllwoodMesaSperling2023}. Although temperature, sunlight, and moisture remained components of the broader Microclimate Hypothesis, wind protection produced an especially specific numerical criterion with direct implications for grove management.

The studies supporting this wind criterion did not directly quantify how monarch clusters responded during measured wind exposure. Instead, wind effects were inferred from comparisons of occupied and unoccupied locations and from later qualitative accounts \cite{leongMicroenvironmentalFactorsAssociated1990,leongUseMultivariateAnalyses1991,leongRestorationOverwinteringGrove1999}. More recent investigations have also complicated the broader Microclimate Hypothesis. Studies across multiple California groves found that temperature, humidity, and light at aggregation locations varied with latitude, local geography, and spatial scale rather than forming a single environmental envelope \cite{sanieeHierarchyScaleInfluence2022,fisherMultiScaleSpeciesDistribution2024}. Those studies did not evaluate butterfly responses to wind, leaving the Wind Disruption Hypothesis unresolved. It therefore remains unclear whether increasing wind consistently reduces cluster size or whether monarch responses to wind depend on associated conditions such as temperature and sunlight \cite{mastersMonarchButterflyDanaus1988,kammerThoracicTemperatureShivering1970,barkerEffectPhotoperiodTemperature1976}.

We conducted an observational field study at two blue gum eucalyptus groves at Vandenberg Space Force Base during the 2023--2024 overwintering season. We paired time-lapse estimates of visible cluster size with nearby wind measurements to determine whether increasing maximum wind gusts predicted declines in the Butterfly Index over immediate and next-day response windows. Under the Wind Disruption Hypothesis, greater wind exposure was expected to precede consisent reductions in visible cluster size, which became larger as wind speeds increased. We evaluated this prediction while accounting for prior cluster size, approximate local temperature, time of day, and sun-exposed BI. The study therefore evaluates whether the predicted association occurred under the monitored conditions rather than providing an experimental or exact test of the historical 2~m/s criterion.
