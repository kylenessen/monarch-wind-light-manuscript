...
These findings raise questions about the applicability of a single wind threshold to the monitored setting, but they do not establish that threshold guidance is broadly invalid. Replicated work across seasons, sites, grove structures, cluster densities, and geographic regions, with within-canopy wind and direct physiological measurements, is needed before management guidance is revised.
