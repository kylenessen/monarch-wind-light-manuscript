...
For the 30-minute analysis, we removed exact duplicate candidates M20 and M44 without renumbering the remaining candidates. The corrected comparison contained 50 unique candidates, of which 49 produced rankable fits. The maximum-likelihood comparison selected M16 rather than the previously reported M50. We consequently replaced the affected 30-minute Methods, Results, tables, figures, and interpretation with results from M16 and its restricted-maximum-likelihood refit.
