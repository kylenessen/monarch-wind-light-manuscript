...
#heading[Reviewer 1]
  ...
  [We changed the Data Availability statement and made the version-controlled repository public at #link("https://github.com/kylenessen/monarch-wind-light-manuscript")[github.com/kylenessen/monarch-wind-light-manuscript]. It contains the processed analysis datasets, analysis code, candidate formulas, fit outcomes, selected-model summaries, sensitivity outputs, and generated figures. The illustrated classification protocol is public at #link("https://kylenessen.github.io/monarch_trailcam_classifier/")[kylenessen.github.io/monarch_trailcam_classifier], and the source code for the custom image-classification software is available at #link("https://github.com/kylenessen/monarch_trailcam_classifier")[github.com/kylenessen/monarch_trailcam_classifier]. A USGS ScienceBase release containing the original photographs, deployment metadata, image classifications, wind measurements, and reviewed image-derived temperature values used in this study is in preparation and will be made publicly available before publication.],
)
