...
For the Next Day Window, we reconstructed the candidate set from the 74 formulas actually defined in the original analysis and added a prespecified linear day-scale analogue of the selected 30-minute three-way model. Sixty-eight of 75 candidates produced rankable fits, and seven fits with convergence warnings were excluded from the ranking and Akaike-weight calculation. The added three-way candidate ranked 24th with a delta AICc of 12.25. M32 remained the selected model after maximum-likelihood comparison and restricted-maximum-likelihood refitting. Its corrected Akaike weight was 0.613, rather than the previously reported 0.85, and the null baseline was second with a delta AICc of 3.58. We therefore retained M32 while moderating the strength-of-support language. The revised manuscript reports the candidate counts, unsuccessful-fit handling, corrected selection results, and updated interpretations for both response windows. Complete candidate formulas, fit outcomes, warnings, and rankings are provided in the supplementary and reproducibility materials.
]
