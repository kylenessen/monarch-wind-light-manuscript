...
para("The public wind table retains deployment_id, wind_sensor_id, timestamp, wind_speed, wind_gust and wind_direction. Wind speed and gust are in meters per second. Gust is the logger maximum for the recording interval, normally one minute. These measurements describe conditions near the logger, rather than sustained exposure at every butterfly position.")
