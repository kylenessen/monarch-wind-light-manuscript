...
para("The photo index covers 59,039 first-season JPEGs and 167,821 reviewed second-season JPEGs. Deployment identifiers are unique across the release. SC12 identifies the first-season NOVA camera and BlueLake wind meter. SC13 identifies the second-season IRIS camera and RockWall wind meter, correcting the reused source label SC12. Join by deployment_id. Add image_filename for photo joins. Analysis tables contain first-season records only.")
