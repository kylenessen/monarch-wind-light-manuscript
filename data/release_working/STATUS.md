...
Updated September 22, 2026. The completed data-release branch has been merged into main. The repository release tables now match the canonical package at /Volumes/MonarchSSD/data_release/publication_package, including the final reviewed metadata, dictionary and NULL values. The 12 original native classification JSON files are published in the [classifier repository](https://github.com/kylenessen/monarch_trailcam_classifier/tree/main/data/classifications). Checksum-identical copies remain in data/deployments for analysis reproducibility. Native JSON files are not release attachments. The current classification summary contains 3,713 records.

Peter supplied the release citation and DOI, [10.5066/P13IEKEB](https://doi.org/10.5066/P13IEKEB), with publication date September 30, 2026. The manuscript now cites the release first in the data availability statement and includes it in the bibliography. The metadata XML retains the September 16 review edits, with its classification links updated on September 22 in this repository, the canonical package and the OneDrive review copy. See the [approval record](../../research/usgs-manuscript-approval-2026-09-16.md) and [release review record](../../research/data-release-review-2026-09-16.md). The release and preview builders no longer copy native JSON into the package. The release builder still predates the other final manual metadata and missing-value edits, so a rebuild requires reapplying those reviewed changes.
